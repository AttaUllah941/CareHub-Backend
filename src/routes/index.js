...
const medicinesPharmacyRoutes = require('../modules/medicines/medicines.pharmacy.routes');
...
router.use('/admin/doctors', doctorsAdminRoutes);
...
router.use('/pharmacy/orders', medicinesPharmacyRoutes);
